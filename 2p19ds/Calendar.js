class calendar{
    ...
    printCalendar(mes,year) {
        ...
        // Número de dias y el inicio del mes lo cual depende del mes y de saber si el año sera bisiesto
        ...
        for (let i = 0; i < 5; i++) {
            if (i == 0) {
                ...
                for (let j = 0; j < 7; j++) {
                    //La matriz con un contador del 1 hasta el número de días del mes
                    if (cont <= dias) {
                        calendar[i][j] = cont;
                        cont++;
                    }
